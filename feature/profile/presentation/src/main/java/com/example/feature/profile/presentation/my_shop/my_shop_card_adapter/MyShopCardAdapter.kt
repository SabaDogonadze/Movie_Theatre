package com.example.feature.profile.presentation.my_shop.my_shop_card_adapter
...
import com.example.feature.profile.presentation.databinding.ViewholderMyShopCardBinding
...
class MyShopCardAdapter :
    ...
    inner class UserOrderViewHolder(private val binding: ViewholderMyShopCardBinding) :
